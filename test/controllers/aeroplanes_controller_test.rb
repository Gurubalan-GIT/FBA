...
class AeroplanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aeroplane" do
    assert_difference('Aeroplane.count') do
      post aeroplanes_url, params: { aeroplane: { seats: @aeroplane.seats, type: @aeroplane.type } }
    end
  ...
  test "should update aeroplane" do
    patch aeroplane_url(@aeroplane), params: { aeroplane: { seats: @aeroplane.seats, type: @aeroplane.type } }
